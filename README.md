# PSOC™ Edge Training - Extended Boot

This training is part of the PSOC™ Edge Security training series and focuses on
Extended Boot and its key features in PSOC™ Edge devices.
This session covers the basics of Extended Boot, including its role in the
hardware Root of Trust, and the verification and launch of RRAM_SE_BOOT
and Extended Boot stored in the device's RRAM.
Additionally, this training covers the Secure Boot option and the support provided
by Edge Protect Tools for provisioning PSOC™ Edge devices.
...
- For an introduction to PSOC™ Edge Security, visit the [PSOC™ Edge Security Intro training](https://github.com/Infineon/mtb-training-psoc-edge-security-intro).
...
## Agenda
1. Introduction to Extended Boot
2. Secure Boot
3. Boot source
4. RAM loading
5. Alternate Serial Interface
6. Replacing Extended Boot
7. Lab #1: Replacing Extended Boot
8. Lab #2: RAM loading using Extended Boot

## Expected outcome
- Get familiar with Extended Boot and its features
...
|------------|---------|-------------|
| 07/02/2026 | *B | Added AI Kit support. |
| 03/17/2026 | *A | Updated instructions for Lab 2.<br>Updated tool versions.<br>Added lab source. |
